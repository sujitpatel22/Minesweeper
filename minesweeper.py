        ...
        for r in range(cell[0]-1, cell[0]+2):
            for c in range(cell[1]-1, cell[1]+2):
                ...
                if (r >= 0 and r < self.height) and (c >= 0 and c < self.width):
                    if not (r, c) in self.safes and not (r, c) in self.mines:
                        newSentence.cells.add((r,c))
                    if (r,c) in self.mines:
                        countMines+=1
        newSentence.count = count - countMines
            ...
            for sentence1 in self.knowledge:
                ...
                for sentence2 in self.knowledge:
                    ...
                    if sentence1.cells.issubset(sentence2.cells):
                        newSubsetSentence = Sentence((sentence2.cells - sentence1.cells), (sentence2.count - sentence1.count))
                        if not newSubsetSentence in self.knowledge:
                            knowledge_changed = True
